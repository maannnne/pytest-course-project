...
# passing the fixture env here as arg, so we are basically building a Config class object, using the env value, which is our current environment
@fixture(scope = 'session')
def app_config(env):
    cfg = Config(env)
    return cfg
